...
- All browsers:
  - For security reasons, you cannot save pages hosted on
    ...
    domains. When this happens, 🛇 is displayed on top of the 沧澜 icon.
  - For
    [security reasons](https://developer.mozilla.org/en-US/docs/Web/HTML/CORS_enabled_image),
    沧澜 is sometimes unable to save the image representation of
  ...
  - The following characters are replaced by their full-width equivalent 
    ...
    options(https://github.com/gildas-lormeau/沧澜/wiki/Hidden-options).
...
- Firefox:
  ...
  - Sometimes, 沧澜 is unable to save the contents of sandboxed iframes
  ...
  - When processing a page from the filesystem, external resources (e.g. images,
    ...
    proposed
    [here](https://github.com/gildas-lormeau/沧澜/issues/7#issuecomment-618980153).
- Waterfox Classic
...
- If saving page in incognito did not fix the issue, reset 沧澜 options.
...
- Please report the issue with a short description on how to reproduce it here:
  https://github.com/gildas-lormeau/沧澜/issues.
